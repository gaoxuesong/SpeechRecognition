...
public class ActivityOffline extends Activity {
    ...
    private final String DESC_TEXT = "" +
            ...
            " 2. 打开计算器(离线)\n" +
            " 3. 明天天气怎么样(需要联网)\n" +
            " 4. 鲁BYQ611,鲁BGC397,鲁B1M22S,鲁B980LK,鲁B168KG," +
            "    鲁B85N02,鲁B612AC,鲁BJ039X,鲁B960FX,鲁B152CH," +
            "    鲁G5638E,鲁B9UA57,鲁B7D8E6,鲁B2MW60,鲁b0a7a6," +
            "    鲁BA3S70,鲁BL98H8,鲁B9FB02(离线)\n" +
            " ..." +
            "\n";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("grammar", "asset:///baidu_speech_grammar_525PM.bsg"); // 设置离线的授权文件(离线模块需要授权), 该语法可以用自定义语义工具生成, 链接http://yuyin.baidu.com/asr#m5
